...
const Footer = () => {
  ...
  return (
    <footer className="bg-[var(--deep-green)] text-white py-12 relative z-10 border-t border-[var(--mint-green)] border-opacity-20" id="footer">
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="#" className="hover:text-[var(--mint-green)] transition-colors duration-300">
                    About Us
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                    ...
                    <Link href="#" className="text-[var(--mint-green)] hover:text-white transition-colors duration-300">
                      <InstagramIcon />
                    </Link>
                      </div>
                </li>
