...
const FeatureCard = ({ title, description, icon, image }) => {
  return (
    <div className="group relative bg-[var(--soft-sand)] p-8 rounded-lg shadow-sm border border-[var(--soft-sand)] hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:bg-[var(--beige)] overflow-hidden">
...
const OrganicFoodIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" className="w-full h-full">
...
const NoPlasticIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="currentColor" fillRule="evenodd" clipRule="evenodd" className="w-full h-full">
